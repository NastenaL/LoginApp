...
export class EmailComponentFactory{
    ...
    public static create() : HTMLDivElement{
        const emailDiv : HTMLDivElement = document.createElement('div');
        const emailInput : HTMLInputElement = this.createInput();
        const emailLabel : HTMLLabelElement = this.createLabel();
